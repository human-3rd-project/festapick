...
export const BackgroundGradient = styled.div`
	...
	background:
		...
		linear-gradient(180deg, rgba(11, 19, 38, 0.16) 0%, rgba(11, 19, 38, 0.78) 100%);
`;
...
export const GlassContainer = styled.section`
	...
	&.success {
		...
		box-shadow:
			0 0 44px rgba(105, 255, 184, 0.08),
			0 30px 70px rgba(0, 0, 0, 0.28);
	}
	...
	&.error {
		...
		box-shadow:
			0 0 44px rgba(255, 180, 171, 0.08),
			0 30px 70px rgba(0, 0, 0, 0.28);
	}
...
export const ResultBox = styled.div`
	...
	&.success {
		border-color: rgba(105, 255, 184, 0.24);
		background:
			linear-gradient(180deg, rgba(105, 255, 184, 0.08) 0%, rgba(255, 255, 255, 0.04) 100%),
	...
	&.error {
		border-color: rgba(255, 180, 171, 0.28);
		background:
			linear-gradient(180deg, rgba(255, 180, 171, 0.08) 0%, rgba(255, 255, 255, 0.04) 100%),
			rgba(255, 255, 255, 0.05);
	}
`;
...
export const FoundId = styled.div`
	display: flex;
	align-items: center;
	justify-content: center;
	gap: 8px;
