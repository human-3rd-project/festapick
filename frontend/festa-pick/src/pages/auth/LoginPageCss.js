...
export const BackgroundGradient = styled.div`
	...
	pointer-events: none;
	background:
		linear-gradient(180deg, rgba(18, 24, 42, 0.28) 0%, rgba(9, 15, 29, 0.72) 100%),
		radial-gradient(circle at 49% 16%, rgba(221, 183, 255, 0.24) 0%, transparent 30%),
		radial-gradient(circle at 75% 78%, rgba(255, 2, 141, 0.18) 0%, transparent 34%),
		radial-gradient(circle at 18% 64%, rgba(183, 109, 255, 0.16) 0%, transparent 36%);
`;
...
export const NeonButton = styled.button`
	...
	box-shadow: 0 10px 24px rgba(255, 2, 141, 0.24), 0 8px 22px rgba(183, 109, 255, 0.24);
	color: #fff;
	border: none;
	font-size: 14px;
	line-height: 20px;
	...
	&:hover {
		box-shadow: 0 16px 34px rgba(255, 2, 141, 0.3), 0 12px 28px rgba(183, 109, 255, 0.32);
